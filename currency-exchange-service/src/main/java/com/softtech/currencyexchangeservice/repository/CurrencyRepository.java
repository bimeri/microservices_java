...
import com.softtech.currencyexchangeservice.controller.CurrencyExchange;
...
public interface CurrencyRepository extends JpaRepository<CurrencyEntity, Long> {
    ...
    CurrencyEntity findAllByCountryAndConversionMultiple(String country, BigDecimal conversionMultiple);
}
